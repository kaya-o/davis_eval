...
def plot_sale_ramdas_relaxed_needed(
    ...
    caption = (
        ...
        "The highlighted RELAXED-EXPRESS column is computed only on selected "
        "events with relaxed_express_relaxation_needed=True."
    )
    fig.text(0.5, 0.047, caption, ha="center", va="bottom", fontsize=9)
    if parameter_text:
